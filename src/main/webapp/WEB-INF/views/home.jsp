...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Online Store</a>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <h1 class="text-uppercase">
                    <strong>Welcome to Online Store</strong>
                </h1>
                <hr>
            </div>
            <div class="col-lg-8 mx-auto">
                <p class="text-faded mb-5">Online Store is for all kinds of products as your ordering! So we are always stay-connecting with all customers!</p>
                <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">See what is in our inventory!</a>
            </div>
        </div>
    </div>
</header>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <hr class="light my-4">
                <p class="text-faded mb-4">Online Store is for all kinds of products as your ordering! So we are always stay-connecting with all customers!</p>
                <a class="btn btn-light btn-xl js-scroll-trigger" href="#services">Lets see our products!</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">All kind of our products</h2>
                <hr class="my-4">
            </div>
        </div>
    </div>
